...
<body class="body-fixed">
    ...
    <!-- Start of Loging Section-->
    <section class="section loging-section">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="form-box">
                        <h2 class="xl-title">Login</h2>
                        <form method="POST" action="php/login.php">
                            ...
                            <div class="input-wp">
                                <div class="checkbox-group">
                                    <input type="checkbox" name="liked" id="remember" value="remember">
                                    <label for="remember">
                                ...
                                <button type="submit" name="btn-login" class="sec-btn bg-btn">log in</button>
                            </div>
                        </form>
<!--                        <div class="forgot-password">-->
<!--                            <p class="m-0"><a href="javascript:void(0);">Forgot Your Password?</a></p>-->
<!--                        </div>-->
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-box">
                        <h2 class="xl-title">Register</h2>
                        <form action="php/register.php" method="POST">
                            <div class="input-wp">
                                <label>Username <span class="required">*</span></label>
                                <input class="form-input" type="text" name="username" id="username-reg" required="">
                            </div>
                            <div class="input-wp">
                                <label>Email Address <span class="required">*</span></label>
                            ...
                            <button type="submit" name="btn-register" id="btn-register" class="sec-btn bg-btn">Register</button>
                        </form>
                    </div>
                </div>
            </div>
