                    ...
                    <ul class="menu">
                        ...
                        <li class="dropdown-items">
                            ...
                            <ul class="sub-menu">
                                ...
                                <!--                                    <li><a title="Product Single" href="product-single.php">Product Single</a></li>-->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="product-info">
                    ...
                    <form class="product-info-cart">
                        <div class="quantity">
                            <input type="number" class="input-text qty" step="1" min="1" name="quantity" value="1"
                                   title="Qty" placeholder="">
                            <button type="submit" name="add-to-cart" class="single_add_to_cart_button sec-btn">Add to
                                cart
                            </button>
                        </div>
                    </form>
